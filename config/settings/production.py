...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["donate-anything.org"])
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "donate_anything.utils.storages.StaticRootS3Boto3Storage"
COLLECTFAST_STRATEGY = "collectfast.strategies.boto3.Boto3Strategy"
STATIC_URL = f"https://{aws_s3_domain}/static/"
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "donate_anything.utils.storages.MediaRootS3Boto3Storage"
