...
# donate_anything/
APPS_DIR = ROOT_DIR / "donate_anything"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "donate_anything.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "donate_anything.utils.context_processors.settings_context",
            ],
        },
    }
]
...
CELERY_BROKER_URL = env("CELERY_BROKER_URL", default=env("REDIS_URL", default="redis://redis:6379"))
...
# Elasticsearch
# ------------------------------------------------------------------------------
# We'll use Elasticsearch once there's enough items to be beneficial
